...
// Create default Messages labels

  _.each(['aideMain','aideFull','aideACL'], 
    function (label) {
      var o = (Messages.find({'mNom':label})).count();
      if (!o) {
          console.log('Insert label : ' + label);
          Messages.insert({ 'mNom' : label });
      };
  }) 
...
//var Vlan = Npm.require(process.cwd()+'/app/server/node_modules/parseacl');
